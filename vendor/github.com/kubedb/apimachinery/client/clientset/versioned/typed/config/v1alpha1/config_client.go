...
import (
	v1alpha1 "github.com/kubedb/apimachinery/apis/config/v1alpha1"
...
// ConfigV1alpha1Client is used to interact with features provided by the config.kubedb.com group.
