...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginVarItem) DeepCopyInto(out *PluginVarItem) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginVarItem.
func (in *PluginVarItem) DeepCopy() *PluginVarItem {
	if in == nil {
		return nil
	}
	out := new(PluginVarItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PluginVars) DeepCopyInto(out *PluginVars) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make(map[string]PluginVarItem, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
