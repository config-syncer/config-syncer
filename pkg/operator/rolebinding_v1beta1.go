...
func (op *Operator) WatchRoleBindingV1beta1() {
	...
	lw := &cache.ListWatch{
		ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
			return op.KubeClient.RbacV1beta1().RoleBindings(apiv1.NamespaceAll).List(metav1.ListOptions{})
		},
		WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
			return op.KubeClient.RbacV1beta1().RoleBindings(apiv1.NamespaceAll).Watch(metav1.ListOptions{})
		},
	}
