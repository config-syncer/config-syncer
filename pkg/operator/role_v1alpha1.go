...
func (op *Operator) WatchRoleV1alpha1() {
	...
	lw := &cache.ListWatch{
		ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
			return op.KubeClient.RbacV1alpha1().Roles(core.NamespaceAll).List(metav1.ListOptions{})
		},
		WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
			return op.KubeClient.RbacV1alpha1().Roles(core.NamespaceAll).Watch(metav1.ListOptions{})
		},
	}
