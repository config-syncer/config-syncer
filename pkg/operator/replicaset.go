...
func (op *Operator) WatchReplicaSets() {
	...
	lw := &cache.ListWatch{
		ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
			return op.KubeClient.ExtensionsV1beta1().ReplicaSets(core.NamespaceAll).List(metav1.ListOptions{})
		},
		WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
			return op.KubeClient.ExtensionsV1beta1().ReplicaSets(core.NamespaceAll).Watch(metav1.ListOptions{})
		},
	}
