...
func (op *Operator) WatchAlertmanager() {
	if !meta.IsPreferredAPIResource(op.KubeClient, prom.Group+"/"+prom.Version, prom.AlertmanagersKind) {
	...
	lw := &cache.ListWatch{
		ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
			return op.PromClient.Alertmanagers(core.NamespaceAll).List(metav1.ListOptions{})
		},
		WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
			return op.PromClient.Alertmanagers(core.NamespaceAll).Watch(metav1.ListOptions{})
		},
	}
