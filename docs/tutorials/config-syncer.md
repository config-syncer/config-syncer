...
## Deploy Kubed
If you have already deployed Kubed, you can skip to the next section. To deploy Kubed, create a Secret with the Kubed cluster config under `config.yaml` key.
...
kind: Secret
metadata:
  creationTimestamp: 2017-07-26T10:19:20Z
  labels:
    app: kubed
  name: kubed-config
  ...
  uid: e3451b27-71eb-11e7-a5ec-0800273df5f2
type: Opaque
```
