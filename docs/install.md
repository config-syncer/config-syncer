...
You may have to create another [Secret for notifiers](/docs/tutorials/notifiers.md), usually called `notifier-info`. If you are [storing cluster snapshots](/docs/tutorials/cluster-snapshot.md) in cloud storage, you have to create another Secret to provide cloud credentials.
