...
**NB:** The event forwarder configuration format has been redesigned in 0.6.0-rc.0 and should be updates accordingly if you are upgrading from a previous version.
